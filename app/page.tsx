    ...
    <main key={"main"} className="mx-auto w-full p-0 flex flex-col gap-14 md:gap-20 xl:gap-28">
      ...
      <section key={"apresentation"} className="grid grid-cols-1 grid-rows-2 md:grid-cols-2 md:grid-rows-1 self-center max-w-[1440px] self gap-5">
        <ContainerText key={"text_apresentation"} aditionalCSS="lg:text-left lg:max-w-[400px] xl:max-w-lg">
          <h1 className="gradient p-2">Crie textos e questões para seus alunos em segundos</h1>
          <p className="w-5/6">A solução que ajuda você a criar questões, textos, frases ou expressões matemáticas para provas e atividades de forma fácil, simples e rápida!</p>
      ...
      <section key={"product"} id="produto" className="flex flex-col gap-7 md:gap-10 xl:gap-20 items-center">
        ...
        <div key={"cards_product"} className="flex flex-col md:flex-row gap-5 lg:gap-10 reveal-card-left">
          <Card key={"card_time"} title="Tempo" img={Time} aditionalCSS="border-[10px] lg:border-[15px] border-orange-2">
            <p>Gere questões, textos, frases ou expressões matemáticas em alguns segundos e tenha mais tempo para você.</p>
          </Card>
          ...
          <Card key={"card_do_yoursef"} title="Faça do seu jeito" img={DoYoursef} aditionalCSS="border-[10px] lg:border-[15px] border-orange-2">
            <p>Aqui você pode copiar a informação de forma fácil e montar a sua prova ou atividade.</p>
          </Card>
        </div>
      ...
      <section key={"how_to_use"} className="flex flex-col gap-5 md:gap-10">
        ...
        <SectionTwoColumns key={"first"} title="1° - Selecione as informações dos alunos e o que deseja gerar" text="Coloque a série, a idade média dos alunos e selecione o que você deseja gerar: questão, texto, frase ou expressão matemática" img={First} borderColor="orange"/>
        <SectionTwoColumns key={"second"} title="2° - Forneça mais informações" text="Aqui você vai nos dar mais informações, por exemplo, talvez você precise fornecer a matéria, a quantidade ou o assunto." img={Second} borderColor="blue" reverse={true} />
        <SectionTwoColumns key={"third"} title="3° - Clique em “Gerar”" text="Agora é so aguardar alguns segundos e o que você gerou vai aparecer na tela" img={Third} borderColor="orange" />
      ...
      <section key={"about"} id="sobre" className="flex flex-col justify-center items-center gap-5 md:gap-10 text-center">
        ...
        <ContainerText key={"text_about"} aditionalCSS="gap-5 md:gap-7 md:max-w-xl xl:max-w-3xl">
          ...
          <p>O projeto {process.env.NEXT_PUBLIC_PROJECT_NAME} teve seu início em janeiro de 2024 nascendo da ideia de facilitar o trabalho dos profissionais da educação. Seu criador possui professores no círculo familiar e percebia a dificuldade deles em achar questões, textos, frases ou expressões matemáticas para suas provas e atividades e, que de uma maneira facilitada, pudessem organizá-las e remodelá-las.</p>
        ...
        <div className="flex flex-col md:flex-row gap-5 lg:gap-10">
          ...
          <Card key={"card_person2"} title="Valquíria" aditionalCSS="border-4 border-orange">
