...
export default function ModalRefactor ({ children, close, customWidth }: {
    ...
    return (
        <div className={`font-normal fixed top-0 left-0 bg-gray-400 dark:bg-gray-900 dark:bg-opacity-80 bg-opacity-40 w-screen h-screen flex justify-center items-center z-10`}>
