...
export default function CardPrice({ title, plan, price, children }: {
    ...
    return (
        <div className={`grid p-3 w-60 lg:w-64 xl:w-72 h-[400px] lg:h-[450px] xl:h-[500px] rounded-xl dark:hover:shadow-slate-800 shadow-md md:hover:mt-[-5px] duration-300 md:hover:shadow-lg border border-blue dark:border`}>
